...
if ($userId) {
    ...
    echo "<script>alert('Hãy đăng nhập để xem thông tin');</script>";
    ...
    <div class="content">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="phone" value="<?php echo htmlspecialchars($user['sdt']); ?>" class="form-control" id="phone">
