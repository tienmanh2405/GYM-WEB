...
<body>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-warning" data-bs-toggle="modal"
                                data-bs-target="#editModal<?php echo $khuyenMai['maKhuyenMai']; ?>">Sửa</button>
                            <a href="<?php echo BASE_URL . 'NV_BaoTri/quanlykhuyenmai/delete/' . $khuyenMai['maKhuyenMai']; ?>"
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="POST" action="<?php echo BASE_URL . 'NV_BaoTri/quanlykhuyenmai/create'; ?>"
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="maGoiTap" required>
                                ...
                                <?php foreach ($maGoiTapList as $goiTap): ?>
                                    <option value="<?php echo $goiTap['maGoiTap']; ?>"><?php echo $goiTap['maGoiTap']; ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        </div>
    ...
    <!-- Modal sửa -->
    <?php foreach ($khuyenMais as $khuyenMai): ?>
        <div class="modal fade" id="editModal<?php echo $khuyenMai['maKhuyenMai']; ?>" tabindex="-1"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="POST" action="<?php echo BASE_URL . 'NV_BaoTri/quanlykhuyenmai/update'; ?>"
                        onsubmit="return validateInput(event)">
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="giamGia"
                                    value="<?php echo $khuyenMai['giamGia']; ?>" required>
                            </div>
                            <div class="mb-3">
                                <label for="ngayBatDau" class="form-label">Ngày Bắt Đầu</label>
                                <input type="date" class="form-control" name="ngayBatDau"
                                    value="<?php echo $khuyenMai['ngayBatDau']; ?>" required>
                            </div>
                            <div class="mb-3">
                                <label for="ngayKetThuc" class="form-label">Ngày Kết Thúc</label>
                                <input type="date" class="form-control" name="ngayKetThuc"
                                    value="<?php echo $khuyenMai['ngayKetThuc']; ?>" required>
                            </div>
                            <div class="mb-3">
                                <label for="moTa" class="form-label">Mô Tả</label>
                                <input type="text" class="form-control" name="moTa"
                                    value="<?php echo $khuyenMai['moTa']; ?>" required>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button>
