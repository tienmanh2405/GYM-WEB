...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-secondary navbar-dark">
        <a href="/GYM-WEB/public/Admin/home" class="navbar-brand mx-4 mb-3">
            <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>TTLT</h3>
        </a>
        <div class="navbar-nav w-100" id="sidebar-menu">
            <a href="/GYM-WEB/public/Admin/home" class="nav-item nav-link"><i class="fas fa-home me-2"></i>Trang chủ</a>
